...
struct Instruction {
    ...
    static var allInstructions: [Instruction] = {
        ...
        var allInstructions = [
            ...
            Instruction(asm: "LD (HL), d8",opcode: 0x36, cycles: 8, execute: { cpu, arg in cpu.ram.write(word: arg, at: cpu.registers.HL) }),
           ...
           // Instruction(asm: "PREFIX",    opcode: 0xCB, cycles: 4, execute: { cpu in  }),
            ...
            Instruction(asm: "LDH (a8), A",opcode: 0xE0, cycles: 12, execute: { cpu, arg in cpu.ram.write(byte: cpu.registers.A, at: (arg + 0xFF00))}),

            Instruction(asm: "POP HL",     opcode: 0xE1, cycles: 12, execute: { cpu in cpu.registers.HL = cpu.pop()}),

            Instruction(asm: "LD (C), A",  opcode: 0xE2, cycles: 8, execute: { cpu in cpu.ram.write(byte: cpu.registers.A, at: UInt16(cpu.registers.C))}),
            ...
            Instruction(asm: "LDH (a16), A",opcode: 0xEA, cycles: 16, execute: { cpu, arg in cpu.ram.write(byte: cpu.registers.A, at: arg)}),
            ...
            Instruction(asm: "LDH A, (a8)",opcode: 0xF0, cycles: 12, execute: { cpu, arg in cpu.registers.A = cpu.ram.read(at: arg) }),

            Instruction(asm: "POP AF",     opcode: 0xF1, cycles: 12, execute: { cpu in cpu.registers.AF = cpu.pop()}),

            Instruction(asm: "LDH A, (C)", opcode: 0xF2, cycles: 12, execute: { cpu in cpu.registers.A = cpu.ram.read(at: UInt16(cpu.registers.C)) }),
            ...
            Instruction(asm: "LDH A, (a16)",opcode: 0xFA, cycles: 16, execute: { cpu, arg in cpu.registers.A = cpu.ram.read(at: arg)}),
