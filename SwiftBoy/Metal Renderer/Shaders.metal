...
vertexShader(uint vertexID [[ vertex_id ]],
             constant AAPLVertex *vertexArray [[ buffer(VertexInputTypeVertices) ]],
             constant vector_uint2 *viewportSizePointer  [[ buffer(VertexInputTypeViewportSize) ]])
...
samplingShader(RasterizerData in [[stage_in]],
               texture2d<half> colorTexture [[ texture(TextureIndexTypeBaseColor) ]])
{
